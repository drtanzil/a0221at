...
This repository contains the ESPHome configuration for **Tank-Z**, an ESP32-based water tank level monitor that uses a serial (UART) ultrasonic distance sensor to measure water levels and integrates seamlessly with Home Assistant.
